...
int main(void) {
    struct testcase tests[N_TESTCASES] = {
        ...
        { 2, {white, red}, {red, white} }, //6
        { 2, {red, blue}, {red, blue} },
        { 2, {blue, red}, {red, blue} },
        { 2, {white, blue}, {white, blue} },
        { 2, {blue, white}, {white, blue} },
        { 6, {blue, red, white, white, blue, red}, {red, red, white, white, blue, blue} },
        { 6, {blue, red, white, white, red, blue}, {red, red, white, white, blue, blue} },  //Ejemplo extra 1
        { 3, {white, white, red}, {red, white, white} },                                    //Ejemplo extra 2
        { 2, {white, red}, {red, white} },                                                  //Ejemplo extra 3
        { 3, {red, red, red}, {red, red, red} },                                            //Ejemplo extra 4
        { 5, {blue, blue, blue, white, red}, {red, white, blue, blue, blue} },             //Ejemplo extra 5    
    };
